...
- [ ] **Daily AI Briefing:** Modify the Gemini prompt to generate a 1-sentence morning summary of the day's schedule (e.g., "Light day today, but don't forget the 3 PM interview.") and stick it to the top of the UI.
